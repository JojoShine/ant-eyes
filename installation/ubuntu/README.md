# Ubuntu 自动安装脚本集合 (Ubuntu 18.04+)

本目录包含了为 Ubuntu 18.04+ 系统优化的自动化安装脚本。所有脚本完全独立，无外部依赖，可直接执行。
...
编辑 `/etc/postgresql/*/main/postgresql.conf` 文件：
...
**Q: 脚本支持哪些 Ubuntu 版本？**
A: 主要支持 Ubuntu 18.04 LTS 及更新版本（20.04, 22.04 等）
